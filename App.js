...
const SwipeScreen1 = () => (
  <View style={estilos.container}>
    <Text style={estilos.texto}>GTA 6 – Primeiro trailer oficial – Assista GTA VI</Text>
    <Image source={require('./imagens/GTA-6-primeiro-trailer-oficial-980x552.png')} style={estilos.imagem} />
  </View>
);
const SwipeScreen2 = () => (
  <View style={estilos.container}>
    <Text style={estilos.texto}>GTA VI Project Americas GTA VI</Text>
    <Image source={require('./imagens/gta-vi-project-americas-map-by-tachyon-v.png')} style={estilos.imagem} />
  </View>
);
const SwipeScreen3 = () => (
  <View style={estilos.container}>
    <Text style={estilos.texto}>Requisitos de PC 'especulados' GTA VI</Text>
    <Image source={require('./imagens/mhe3tuady85c1.png')} style={estilos.imagem} />
  </View>
);
...
const PerfilScreen = ({ navigation, route }) => {
  ...
  const [imagem, setImagem] = useState(require('./imagens/kayine.PNG'));
